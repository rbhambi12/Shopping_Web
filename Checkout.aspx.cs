...
public partial class CheckCart : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>alert('Please Select Some Products')</script>");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Request.Cookies["cartcookie"] != null && Request.Cookies["cartcookie"].Value != "")
        {
            ...
            cmd.Parameters.AddWithValue("@code", numIterations);
            ...
            {
                cmd.CommandText = "insert into tborder(address,mobile,productid,status,code) values(@address,@mobile,"+i+",@status,@code)";
                cmd.ExecuteNonQuery();
            }
            cmd.Dispose();
            con.Close();
            ...
            Response.Redirect("Thankyou.aspx?code="+ numIterations);
        }
